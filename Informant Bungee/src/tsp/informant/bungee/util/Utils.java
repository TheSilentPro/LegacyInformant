...
import tsp.informant.bungee.client.SpigotResource;
import tsp.informant.bungee.client.SpigotResourceStatistics;

public class Utils {

    private static final Configuration config = Informant.getInstance().getConfig();
